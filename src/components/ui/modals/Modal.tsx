...
let activeModalOwner: symbol | null = null;

function claimModal(token: symbol): boolean {
  if (activeModalOwner !== null && activeModalOwner !== token) {
    return false;
  }
  activeModalOwner = token;
  return true;
}

function releaseModal(token: symbol) {
  if (activeModalOwner === token) {
...
export function Modal({
  ...
  }, [visible, token, backdropOpacity, contentOpacity, contentScale, contentTranslateY]);
